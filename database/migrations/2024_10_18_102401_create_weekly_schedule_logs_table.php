...
return new class extends Migration
{
    ...
    {
        Schema::create('weekly_schedule_logs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('weekly_schedule_id')->constrained('weekly_schedules')->onDelete('cascade');
            $table->string('action'); // Program ile ilgili yapılan işlem
    ...
    {
        Schema::dropIfExists('weekly_schedule_log');
    }
};
